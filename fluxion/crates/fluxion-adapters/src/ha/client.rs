...
use crate::ha::errors::{HaError, HaResult};
use crate::ha::types::{HaEntityState, HaHistoryState, HistoryDataPoint};
...
impl HomeAssistantClient {
    ...
    /// # Example
    /// ```no_run
    /// # use fluxion_adapters::ha::client::HomeAssistantClient;
    /// # use serde_json::json;
    /// # async fn example() {
