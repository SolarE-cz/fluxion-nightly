...
1. **Push to GitLab**:
   ...
   ```bash
   git remote add gitlab https://gitlab.com/SolarE-cz/fluxion.git
...
2. **repository.yaml**:
   ...
   url: https://gitlab.com/SolarE-cz/fluxion-addon
...
3. **Add to Home Assistant**:
   ...
   - Add URL: `https://gitlab.com/SolarE-cz/fluxion-addon`
   - Install "FluxION ECS"
